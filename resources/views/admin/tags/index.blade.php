                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($tags as $tag)
                                    <tr>
                                        ...
                                        <td>{{$tag->title}}</td>
                                        <td>
                                            <a href="{{route('admin.tags.show', $tag->id)}}" class="btn btn-app"><i class="fas fa-eye"></i></a>
                                            <a href="{{route('admin.tags.edit', $tag->id)}}" class="text-success btn btn-app"><i class="fas fa-edit"></i></a>
                                            <form action="{{route('admin.tags.delete', $tag->id)}}" method="POST" class=" btn ">
                                                @csrf
                                                @method("DELETE")
